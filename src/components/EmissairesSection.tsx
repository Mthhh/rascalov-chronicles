  ...
  const characters = [
    {
      ...
      fsbNote: 'Sujet extrêmement dangereux. Mikhaïl n\'utilise la violence que lorsque la logique a échoué. Sa véritable dangerosité réside dans sa patience infinie et sa capacité à retourner n\'importe quelle situation à son avantage. Suspect dans 14 affaires non résolues. Aucune preuve directe.',
      icon: Brain,
      clearance: 'УРОВЕНЬ 5',
      birthYear: '1989',
      birthPlace: 'Saint-Pétersbourg, Russie',
      biography: 'Élevé dans l\'ombre de son grand-père Sergueï Mikhailov, Mikhaïl a été formé dès l\'enfance aux subtilités du pouvoir. Diplômé en économie à l\'Université d\'État de Moscou, il a passé 5 ans à Londres où il a établi des contacts dans la finance internationale. Son retour en Russie en 2018 a marqué le début de la modernisation des opérations familiales. Après la purge de 2023, il a été désigné pour mener l\'Opération Sokol à Los Santos.',
    ...
    },
    {
      ...
      codename: 'KAIDAN',
      title: "L'OPÉRATEUR",
      role: 'Ex-unité d\'élite, il est l\'ombre de Mikhaïl et le bras armé de la famille.',
